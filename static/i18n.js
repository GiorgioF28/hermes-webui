...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    daily_command_empty: 'Hermes Control Center data is not available in this workspace yet.',
    daily_command_operating_surface: 'Hermes OS Control Center',
    daily_command_today: 'Today command surface',
    daily_command_notes: 'Vault notes',
    daily_command_open_today: 'Open today',
    daily_command_backlog: 'Open backlog',
    daily_command_next_actions: 'Next actions',
    daily_command_active_projects: 'Active projects',
    daily_command_priority_backlog: 'Priority backlog',
    daily_command_project_notes: 'Project notes',
    daily_command_project_cockpit: 'Project cockpit',
    daily_command_action_queue: 'Action queue',
    daily_command_risks: 'Risks',
    daily_command_note: 'Note',
    daily_command_tasks: 'tasks',
    daily_command_bring_to_chat: 'Bring to chat',
    daily_command_brought_to_chat: 'Task prompt added to chat.',
    daily_command_set_next_action: 'Set next action',
    daily_command_next_action_prompt: 'New next action',
    daily_command_update_project: 'Project',
    daily_command_next_action_preview: 'Next action',
    daily_command_confirm_update: 'Update project next action?',
    daily_command_next_action_saved: 'Next action saved.',
    daily_command_no_action_queue: 'No actionable queue items found.',
    daily_command_tasks_missing_project: 'Tasks without project',
    daily_command_tasks_missing_next_action: 'Tasks without next action',
    daily_command_tasks_unknown_project: 'Tasks with unknown project',
    daily_command_projects_missing_next_action: 'Projects without next action',
    daily_command_projects_missing_note: 'Projects without note',
    daily_command_no_project_tasks: 'No open tasks linked to this project.',
    daily_command_no_note_link: 'No linked project note',
    daily_command_no_open_today: 'No open tasks in today.md.',
    daily_command_no_projects: 'No active projects found.',
    daily_command_no_backlog: 'No open backlog tasks found.',
    daily_command_no_notes: 'No project notes found.',
  ...
  folder_add_as_space_title: 'Aggiungere come Spazio?',
    ...
    daily_command: 'Daily Command',
    daily_command_empty: 'I dati di Hermes Control Center non sono ancora disponibili in questo workspace.',
    daily_command_operating_surface: 'Hermes OS Control Center',
    daily_command_today: 'Superficie comando di oggi',
    daily_command_notes: 'Note vault',
    daily_command_open_today: 'Aperte oggi',
    daily_command_backlog: 'Backlog aperto',
    daily_command_next_actions: 'Prossime azioni',
    daily_command_active_projects: 'Progetti attivi',
    daily_command_priority_backlog: 'Backlog prioritario',
    daily_command_project_notes: 'Note progetto',
    daily_command_project_cockpit: 'Project cockpit',
    daily_command_action_queue: 'Action Queue',
    daily_command_risks: 'Rischi',
    daily_command_note: 'Nota',
    daily_command_tasks: 'task',
    daily_command_bring_to_chat: 'Porta in chat',
    daily_command_brought_to_chat: 'Prompt della task portato in chat.',
    daily_command_set_next_action: 'Imposta prossima azione',
    daily_command_next_action_prompt: 'Nuova prossima azione',
    daily_command_update_project: 'Progetto',
    daily_command_next_action_preview: 'Prossima azione',
    daily_command_confirm_update: 'Aggiornare la prossima azione del progetto?',
    daily_command_next_action_saved: 'Prossima azione salvata.',
    daily_command_no_action_queue: 'Nessun elemento azionabile trovato.',
    daily_command_tasks_missing_project: 'Task senza progetto',
    daily_command_tasks_missing_next_action: 'Task senza prossima azione',
    daily_command_tasks_unknown_project: 'Task con progetto sconosciuto',
    daily_command_projects_missing_next_action: 'Progetti senza prossima azione',
    daily_command_projects_missing_note: 'Progetti senza nota',
    daily_command_no_project_tasks: 'Nessuna task aperta collegata a questo progetto.',
    daily_command_no_note_link: 'Nessuna nota progetto collegata',
    daily_command_no_open_today: 'Nessuna task aperta in today.md.',
    daily_command_no_projects: 'Nessun progetto attivo trovato.',
    daily_command_no_backlog: 'Nessuna task backlog aperta trovata.',
    daily_command_no_notes: 'Nessuna nota progetto trovata.',
